...
def load_coco_data(datadir):
    train_transform, test_transform = _data_transforms_coco()

    coco_train_ds = CocoDataset(datadir, train=True, download=True, transform=train_transform)
    coco_test_ds = CocoDataset(datadir, train=False, download=True, transform=test_transform)

    X_train, y_train = coco_train_ds.data, coco_train_ds.target
    X_test, y_test = coco_test_ds.data, coco_test_ds.target

    return (X_train, y_train, X_test, y_test)

def partition_data(dataset, datadir, partition, n_nets, alpha):
    logging.info("*********partition data***************")
    X_train, y_train, X_test, y_test = load_coco_data(datadir)
...
def get_dataloader_test(dataset, datadir, train_bs, test_bs, dataidxs_train, dataidxs_test):
    return get_dataloader_test_coco(datadir, train_bs, test_bs, dataidxs_train, dataidxs_test)
